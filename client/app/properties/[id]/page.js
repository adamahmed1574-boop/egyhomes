        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl shadow-xl sticky top-24 border border-gray-100 dark:border-zinc-800">
                    ...
                    <a href={`https://wa.me/201008279766?text=I am interested in ${property.title} (Ref: ${property._id})`} target="_blank" className="block w-full bg-emerald-600 hover:bg-emerald-700 text-white text-center py-4 rounded-xl font-bold transition shadow-lg mb-4">WhatsApp Inquiry</a>
                    ...
                    {property.listingType === 'Buy' && (
                        <div className="border-t dark:border-zinc-800 pt-6 mt-6">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 text-center">
                                ...
                                <div className="mt-2 text-[10px] text-blue-400 flex justify-between"><span>Rate: {property.interestRate}%</span><span>DP: {downPayment.toLocaleString()} EGP</span></div>
                            </div>
                        </div>
                    )}
                </div>
