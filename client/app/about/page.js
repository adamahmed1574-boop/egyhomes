    ...
    <div className="bg-gray-50 dark:bg-zinc-950 min-h-screen text-slate-800 dark:text-slate-100 pb-20 transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto p-6 -mt-16 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Contact Info (Style Matched) */}
            <div className="bg-white dark:bg-zinc-900 p-10 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-zinc-800 flex flex-col justify-center">
                <h2 className="text-3xl font-bold mb-8 text-slate-900 dark:text-white">Get in Touch</h2>
                
                {/* Contact Details */}
                <div className="space-y-6 text-lg mb-12">
                    <a href="https://wa.me/201008279766" target="_blank" className="flex items-center gap-4 text-slate-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition group">
                        <span className="bg-emerald-100 dark:bg-emerald-900/30 p-3 rounded-full text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition">
                    ...
                    <a href="mailto:egyhomes1@hotmail.com" className="flex items-center gap-4 text-slate-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition group">
                        <span className="bg-emerald-100 dark:bg-emerald-900/30 p-3 rounded-full text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition">
                ...
                {/* Social Buttons */}
                <div>
                    <p className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-4">Follow Us</p>
                    <div className="flex gap-4">
                        <a href="https://instagram.com/egyhomes.eg" target="_blank" className="bg-gray-100 dark:bg-zinc-800 p-4 rounded-2xl hover:bg-pink-100 dark:hover:bg-pink-900/20 text-gray-600 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 transition transform hover:-translate-y-1 shadow-sm">
                        ...
                        <a href="https://facebook.com/share/1DTsE2L6R3/?mibextid=wwXIfr" target="_blank" className="bg-gray-100 dark:bg-zinc-800 p-4 rounded-2xl hover:bg-blue-100 dark:hover:bg-blue-900/20 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition transform hover:-translate-y-1 shadow-sm">
                         ...
                         <a href="https://wa.me/201008279766" target="_blank" className="bg-gray-100 dark:bg-zinc-800 p-4 rounded-2xl hover:bg-green-100 dark:hover:bg-green-900/20 text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition transform hover:-translate-y-1 shadow-sm">
